      ...
      <Card hoverEffect={false} className="max-w-2xl mx-auto p-8 border-emerald-500/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Email Address */}
            <div>
              <label htmlFor="page-college-email" className="block text-xs font-mono font-medium uppercase tracking-wider text-slate-400 mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Phone Number */}
            <div>
              <label htmlFor="page-contact-phone" className="block text-xs font-mono font-medium uppercase tracking-wider text-slate-400 mb-2">
                Contact Phone <span className="text-emerald-500">*</span>
              </label>
              <input id="page-contact-phone"
                type="tel"
                required
            ...
            {/* Graduation Year */}
            <div>
              <label htmlFor="page-graduation-year" className="block text-xs font-mono font-medium uppercase tracking-wider text-slate-400 mb-2">
                Graduation Year
              </label>
          ...
          {/* Select Event */}
          <div>
            <label htmlFor="page-select-sprint-event" className="block text-xs font-mono font-medium uppercase tracking-wider text-slate-400 mb-2">
              Select Sprint Event <span className="text-emerald-500">*</span>
            </label>
            <select id="page-select-sprint-event"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Coding Level */}
            <div>
              <label htmlFor="page-my-coding-level" className="block text-xs font-mono font-medium uppercase tracking-wider text-slate-400 mb-2">
                My Coding Level
              </label>
              <select id="page-my-coding-level"
            ...
            {/* Preferred Language */}
            <div>
              <label htmlFor="page-preferred-language" className="block text-xs font-mono font-medium uppercase tracking-wider text-slate-400 mb-2">
                Preferred Language
              </label>
              <select id="page-preferred-language"
          ...
          {/* Reason for joining */}
          <div>
            <label htmlFor="page-why-do-you-want-to-join-this-session" className="block text-xs font-mono font-medium uppercase tracking-wider text-slate-400 mb-2">
              Why do you want to join this session?
            </label>
            <textarea id="page-why-do-you-want-to-join-this-session"
              placeholder="Describe your learning objectives&hellip;"
